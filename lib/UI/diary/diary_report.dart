...
class diaryreport extends StatefulWidget {
  @override
  _diaryreport createState() => _diaryreport();
}

class _diaryreport extends State<diaryreport> {
  String nickname = "";
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        content: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("일기를 통해 나의 감정을 객관적으로 확인하고, 그날의 나를 돌아볼 수 있어요!"),
