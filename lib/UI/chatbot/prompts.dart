...
Future<Map<String, String>> loadPrompts() async {
  ...
  return {
    ...
    "periodFeedbackPrompt": """
          ...
          예시:
          - "최근 1주일간의 대화에서 ${userData?['nickname']}은 주로 불안한 감정을 표현했으며, 시험과 관련된 고민이 반복적으로 나타났습니다. 그러나 금요일 이후부터 감정이 점차 안정되는 모습을 보입니다."
          
          이런식으로 사용자가 선택한 기간을 요약하는 피드백을 주세요.
          """,
  };
}
